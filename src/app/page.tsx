...
<section id="attention" className="hero-dark"><div className="section-wrap hero hero-inner"><div className="hero-copy"><p className="eyebrow light"><span /> Visitor intelligence for creators</p><h1>Attention is the<br /><em>real</em> currency.</h1><p className="hero-sub">There are two versions of your reach — the public number everyone sees, and the engaged audience sponsors actually pay for. CreatorPixel shows you both, and exactly who&apos;s behind them.</p><div className="hero-actions"><a className="button button-primary button-large" href="/auth/login?mode=signup">Get your pixel — free <ArrowRight /></a><a className="watch-link" href="#how">See how it works</a></div><p className="hero-note">Free to install. No credit card. Works anywhere you can paste a script.</p></div><div className="hero-visual"><div className="device-frame"><div className="device-bar"><span className="traffic-lights"><i /><i /><i /></span><span className="device-url">app.creatorpixel.com/dashboard</span></div><div className="device-screen"><AttentionPanel wide /></div></div></div></div></section>
